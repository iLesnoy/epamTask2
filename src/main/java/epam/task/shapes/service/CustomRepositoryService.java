...
public class CustomRepositoryService {
    ...
    public void fillConeRepository(Point center, double edge, double height) throws CustomException {
    ...
    public void fillConeRepository(double[] array) throws CustomException {
